...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__54216){
var map__54217 = p__54216;
var map__54217__$1 = cljs.core.__destructure_map(map__54217);
var request = map__54217__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54217__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__54220 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__54220.cljs$core$IFn$_invoke$arity$1 ? fexpr__54220.cljs$core$IFn$_invoke$arity$1(response) : fexpr__54220.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__54221 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__54221.cljs$core$IFn$_invoke$arity$1 ? fexpr__54221.cljs$core$IFn$_invoke$arity$1(response) : fexpr__54221.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__54222){
var map__54223 = p__54222;
var map__54223__$1 = cljs.core.__destructure_map(map__54223);
var request = map__54223__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54223__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
