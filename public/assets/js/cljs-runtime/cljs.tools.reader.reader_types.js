...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45171 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45171(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45172 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45172(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45178 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45178(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45179 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45179(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45180 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45180(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45181 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45181(reader);
}
});
...
var G__45191 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45192 = s.append(c);
c = G__45191;
s = G__45192;
continue;
}
