...
}catch (e45043){var _e__41673__auto__ = e45043;
return false;
...
}catch (e45045){var _e__41673__auto__ = e45045;
return false;
...
}catch (e45047){var _e__41673__auto__ = e45047;
return false;
...
}catch (e45049){var _e__41673__auto__ = e45049;
return false;
...
}catch (e45051){var _e__41673__auto__ = e45051;
return false;
}})())){
...
}catch (e45053){var _e__41673__auto__ = e45053;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__45055 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__45056 = (function (){var or__4212__auto__ = config;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__45056);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__45055);
}});
});
...
return (function() { 
var G__45058__delegate = function (args){
...
while (G__45060__i < G__45060__a.length) {G__45060__a[G__45060__i] = arguments[G__45060__i + 0]; ++G__45060__i;}
  args = new cljs.core.IndexedSeq(G__45060__a,0,null);
} 
return G__45058__delegate.call(this,args);};
G__45058.cljs$lang$maxFixedArity = 0;
G__45058.cljs$lang$applyTo = (function (arglist__45061){
var args = cljs.core.seq(arglist__45061);
return G__45058__delegate(args);
});
