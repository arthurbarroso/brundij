...
var len__4818__auto___44800 = arguments.length;
var i__4819__auto___44801 = (0);
while(true){
if((i__4819__auto___44801 < len__4818__auto___44800)){
args__4824__auto__.push((arguments[i__4819__auto___44801]));

var G__44802 = (i__4819__auto___44801 + (1));
i__4819__auto___44801 = G__44802;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq44689){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44690,G__44691,seq44689__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__44703_SHARP_){
return (!((cljs.core.meta(p1__44703_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44717__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e44718){var _e__41673__auto__ = e44718;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e44720){var _e__41673__auto__ = e44720;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__44723 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__44724 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__44724);

try{var map__44725 = opts;
var map__44725__$1 = cljs.core.__destructure_map(map__44725);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44725__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__44723);
}});
...
var temp__5733__auto___44813 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___44813)){
var managed_print_level_44814 = temp__5733__auto___44813;
var _STAR_print_level_STAR__orig_val__44736_44815 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__44737_44816 = managed_print_level_44814;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__44737_44816);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__44735_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__44735_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__44736_44815);
}} else {
job_fn();
}
