...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49893 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49893(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_49894 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_49894(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_49895 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_49895(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_49896 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_49896(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49897 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49897(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49901 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49901(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__49888,callback){
var map__49889 = p__49888;
var map__49889__$1 = cljs.core.__destructure_map(map__49889);
var input = map__49889__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49889__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49889__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
