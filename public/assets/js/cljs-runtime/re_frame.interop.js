...
return [(function (){var pred__52798 = cljs.core.instance_QMARK_;
var expr__52799 = reactive_val;
if(cljs.core.truth_((pred__52798.cljs$core$IFn$_invoke$arity$2 ? pred__52798.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52799) : pred__52798.call(null,reagent.ratom.RAtom,expr__52799)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52798.cljs$core$IFn$_invoke$arity$2 ? pred__52798.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52799) : pred__52798.call(null,reagent.ratom.RCursor,expr__52799)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52798.cljs$core$IFn$_invoke$arity$2 ? pred__52798.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52799) : pred__52798.call(null,reagent.ratom.Reaction,expr__52799)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52798.cljs$core$IFn$_invoke$arity$2 ? pred__52798.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52799) : pred__52798.call(null,reagent.ratom.Track,expr__52799)))){
return "tr";
} else {
return "other";
}
