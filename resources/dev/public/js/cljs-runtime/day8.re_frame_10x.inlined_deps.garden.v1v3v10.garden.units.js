 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__47656,right){
var map__47657 = p__47656;
var map__47657__$1 = cljs.core.__destructure_map(map__47657);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47657__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47657__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__47658 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47658,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47658,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47658,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47661__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__47662 = u(y);
var map__47662__$1 = cljs.core.__destructure_map(map__47662);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47662__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__47670__delegate = function (x,y,more){
...
var G__47670 = function (x,y,var_args){
var more = null;
...
while (G__47673__i < G__47673__a.length) {G__47673__a[G__47673__i] = arguments[G__47673__i + 2]; ++G__47673__i;}
  more = new cljs.core.IndexedSeq(G__47673__a,0,null);
} 
return G__47670__delegate.call(this,x,y,more);};
G__47670.cljs$lang$maxFixedArity = 2;
G__47670.cljs$lang$applyTo = (function (arglist__47674){
var x = cljs.core.first(arglist__47674);
arglist__47674 = cljs.core.next(arglist__47674);
var y = cljs.core.first(arglist__47674);
var more = cljs.core.rest(arglist__47674);
return G__47670__delegate(x,y,more);
});
...
G__47675 = new cljs.core.IndexedSeq(G__47676__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__47675);
}
...
var map__47663 = u(x);
var map__47663__$1 = cljs.core.__destructure_map(map__47663);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47663__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__47664 = u(y);
var map__47664__$1 = cljs.core.__destructure_map(map__47664);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47664__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__47679__delegate = function (x,y,more){
...
var G__47679 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__47680__i = 0, G__47680__a = new Array(arguments.length -  2);
while (G__47680__i < G__47680__a.length) {G__47680__a[G__47680__i] = arguments[G__47680__i + 2]; ++G__47680__i;}
  more = new cljs.core.IndexedSeq(G__47680__a,0,null);
} 
return G__47679__delegate.call(this,x,y,more);};
G__47679.cljs$lang$maxFixedArity = 2;
G__47679.cljs$lang$applyTo = (function (arglist__47681){
var x = cljs.core.first(arglist__47681);
arglist__47681 = cljs.core.next(arglist__47681);
var y = cljs.core.first(arglist__47681);
var more = cljs.core.rest(arglist__47681);
return G__47679__delegate(x,y,more);
});
...
var G__47682 = null;
if (arguments.length > 2) {
var G__47683__i = 0, G__47683__a = new Array(arguments.length -  2);
while (G__47683__i < G__47683__a.length) {G__47683__a[G__47683__i] = arguments[G__47683__i + 2]; ++G__47683__i;}
G__47682 = new cljs.core.IndexedSeq(G__47683__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__47682);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47665__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__47666 = u(y);
var map__47666__$1 = cljs.core.__destructure_map(map__47666);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47666__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__47687__delegate = function (x,y,more){
...
var G__47687 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
while (G__47688__i < G__47688__a.length) {G__47688__a[G__47688__i] = arguments[G__47688__i + 2]; ++G__47688__i;}
  more = new cljs.core.IndexedSeq(G__47688__a,0,null);
} 
return G__47687__delegate.call(this,x,y,more);};
G__47687.cljs$lang$maxFixedArity = 2;
G__47687.cljs$lang$applyTo = (function (arglist__47690){
var x = cljs.core.first(arglist__47690);
arglist__47690 = cljs.core.next(arglist__47690);
var y = cljs.core.first(arglist__47690);
var more = cljs.core.rest(arglist__47690);
return G__47687__delegate(x,y,more);
});
...
var G__47691 = null;
if (arguments.length > 2) {
var G__47692__i = 0, G__47692__a = new Array(arguments.length -  2);
while (G__47692__i < G__47692__a.length) {G__47692__a[G__47692__i] = arguments[G__47692__i + 2]; ++G__47692__i;}
G__47691 = new cljs.core.IndexedSeq(G__47692__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__47691);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47667__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__47668 = u(y);
var map__47668__$1 = cljs.core.__destructure_map(map__47668);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47668__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__47693__delegate = function (x,y,more){
...
var G__47693 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__47694__i = 0, G__47694__a = new Array(arguments.length -  2);
while (G__47694__i < G__47694__a.length) {G__47694__a[G__47694__i] = arguments[G__47694__i + 2]; ++G__47694__i;}
  more = new cljs.core.IndexedSeq(G__47694__a,0,null);
} 
return G__47693__delegate.call(this,x,y,more);};
G__47693.cljs$lang$maxFixedArity = 2;
G__47693.cljs$lang$applyTo = (function (arglist__47695){
var x = cljs.core.first(arglist__47695);
arglist__47695 = cljs.core.next(arglist__47695);
var y = cljs.core.first(arglist__47695);
var more = cljs.core.rest(arglist__47695);
return G__47693__delegate(x,y,more);
});
...
var G__47696 = null;
if (arguments.length > 2) {
var G__47697__i = 0, G__47697__a = new Array(arguments.length -  2);
while (G__47697__i < G__47697__a.length) {G__47697__a[G__47697__i] = arguments[G__47697__i + 2]; ++G__47697__i;}
G__47696 = new cljs.core.IndexedSeq(G__47697__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__47696);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
