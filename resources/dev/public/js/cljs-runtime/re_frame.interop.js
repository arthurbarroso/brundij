...
return [(function (){var pred__48762 = cljs.core.instance_QMARK_;
var expr__48763 = reactive_val;
if(cljs.core.truth_((pred__48762.cljs$core$IFn$_invoke$arity$2 ? pred__48762.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__48763) : pred__48762.call(null,reagent.ratom.RAtom,expr__48763)))){
return "ra";
} else {
if(cljs.core.truth_((pred__48762.cljs$core$IFn$_invoke$arity$2 ? pred__48762.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__48763) : pred__48762.call(null,reagent.ratom.RCursor,expr__48763)))){
return "rc";
} else {
if(cljs.core.truth_((pred__48762.cljs$core$IFn$_invoke$arity$2 ? pred__48762.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__48763) : pred__48762.call(null,reagent.ratom.Reaction,expr__48763)))){
return "rx";
} else {
if(cljs.core.truth_((pred__48762.cljs$core$IFn$_invoke$arity$2 ? pred__48762.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__48763) : pred__48762.call(null,reagent.ratom.Track,expr__48763)))){
return "tr";
} else {
return "other";
}
