...
if((c === "\n")){
var G__52096 = escape_QMARK_;
var G__52097 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__52096;
lines = G__52097;
continue;
} else {
buf.append(c);

var G__52098 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__52099 = lines;
escape_QMARK_ = G__52098;
lines = G__52099;
continue;
...
var G__52093 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__52093) : rewrite_clj.node.string_node.call(null,G__52093));
});
...
var G__52094 = cljs.core.re_pattern(regex);
var G__52095 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__52094,G__52095) : rewrite_clj.node.token_node.call(null,G__52094,G__52095));
});
