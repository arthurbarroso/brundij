...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__52536,k,f){
var vec__52537 = p__52536;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52537,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52537,(1),null);
var loc = vec__52537;
...
var G__52568 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__52568;
continue;
}
break;
...
var G__52569 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__52569;
continue;
} else {
return zloc__$1;
...
var G__52570 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__52570;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__52552){
var vec__52553 = p__52552;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52553,(0),null);
var map__52556 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52553,(1),null);
var map__52556__$1 = cljs.core.__destructure_map(map__52556);
var path = map__52556__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52556__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__52553;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__52557){
var vec__52558 = p__52557;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52558,(0),null);
var map__52561 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52558,(1),null);
var map__52561__$1 = cljs.core.__destructure_map(map__52561);
var path = map__52561__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52561__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__52558;
if(cljs.core.seq(r)){
...
var vec__52563 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52563,(0),null);
var map__52566 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52563,(1),null);
var map__52566__$1 = cljs.core.__destructure_map(map__52566);
var path = map__52566__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52566__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52566__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52566__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52566__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
