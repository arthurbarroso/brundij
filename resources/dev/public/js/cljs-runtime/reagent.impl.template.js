...
var G__48620 = o;
goog.object.set(G__48620,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__48645__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__48645 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__48646__i = 0, G__48646__a = new Array(arguments.length -  0);
while (G__48646__i < G__48646__a.length) {G__48646__a[G__48646__i] = arguments[G__48646__i + 0]; ++G__48646__i;}
  args = new cljs.core.IndexedSeq(G__48646__a,0,null);
} 
return G__48645__delegate.call(this,args);};
G__48645.cljs$lang$maxFixedArity = 0;
G__48645.cljs$lang$applyTo = (function (arglist__48647){
var args = cljs.core.seq(arglist__48647);
return G__48645__delegate(args);
});
G__48645.cljs$core$IFn$_invoke$arity$variadic = G__48645__delegate;
return G__48645;
})()
;
} else {
...
var G__48622 = o;
goog.object.set(G__48622,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__48648__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__48649__i < G__48649__a.length) {G__48649__a[G__48649__i] = arguments[G__48649__i + 0]; ++G__48649__i;}
  args = new cljs.core.IndexedSeq(G__48649__a,0,null);
} 
return G__48648__delegate.call(this,args);};
G__48648.cljs$lang$maxFixedArity = 0;
G__48648.cljs$lang$applyTo = (function (arglist__48650){
var args = cljs.core.seq(arglist__48650);
return G__48648__delegate(args);
});
...
var G__48623 = props;
var G__48623__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48623,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__48623);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48623__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__48624 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__48624;
}
})(),id_class);
...
var G__48625 = (cljs.core.count(argv) - first_child);
switch (G__48625) {
case (0):
...
var vec__48626 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48626,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48626,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48626,(2),null);
...
var temp__5739__auto___48658 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___48658 == null)){
} else {
var key_48659 = temp__5739__auto___48658;
(jsprops.key = key_48659);
}
...
var temp__5739__auto___48660 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___48660 == null)){
} else {
var key_48661 = temp__5739__auto___48660;
(jsprops.key = key_48661);
}
...
var temp__5739__auto___48665 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___48665 == null)){
} else {
var key_48667 = temp__5739__auto___48665;
(jsprops.key = key_48667);
}
...
var temp__5739__auto___48670 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___48670 == null)){
} else {
var key_48672 = temp__5739__auto___48670;
(jsprops.key = key_48672);
}
...
var temp__5739__auto___48675 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___48675 == null)){
} else {
var key_48676 = temp__5739__auto___48675;
(jsprops.key = key_48676);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48635_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__48635_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__48636 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48636,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48636,(1),null);
...
break;
default:
var G__48683 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__48684 = compiler;
v = G__48683;
compiler = G__48684;
continue;
...
var G__48640 = tag;
var G__48640__$1 = (((G__48640 instanceof cljs.core.Keyword))?G__48640.fqn:null);
switch (G__48640__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template48642 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template48642 = (function (opts,id,fn_to_element,parse_fn,meta48643){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template48642.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_48644,meta48643__$1){
var self__ = this;
var _48644__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template48642(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta48643__$1));
}));

(reagent.impl.template.t_reagent$impl$template48642.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_48644){
var self__ = this;
var _48644__$1 = this;
return self__.meta48643;
}));

(reagent.impl.template.t_reagent$impl$template48642.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template48642.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template48642.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template48642.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template48642.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template48642.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta48643","meta48643",-1320445260,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template48642.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template48642.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template48642");

(reagent.impl.template.t_reagent$impl$template48642.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template48642");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template48642.
 */
reagent.impl.template.__GT_t_reagent$impl$template48642 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template48642(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta48643){
return (new reagent.impl.template.t_reagent$impl$template48642(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta48643));
});

}

return (new reagent.impl.template.t_reagent$impl$template48642(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
