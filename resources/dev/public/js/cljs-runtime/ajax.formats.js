...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__65744){
var map__65745 = p__65744;
var map__65745__$1 = cljs.core.__destructure_map(map__65745);
var request = map__65745__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65745__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__65748 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__65748.cljs$core$IFn$_invoke$arity$1 ? fexpr__65748.cljs$core$IFn$_invoke$arity$1(response) : fexpr__65748.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__65749 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__65749.cljs$core$IFn$_invoke$arity$1 ? fexpr__65749.cljs$core$IFn$_invoke$arity$1(response) : fexpr__65749.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__65750){
var map__65751 = p__65750;
var map__65751__$1 = cljs.core.__destructure_map(map__65751);
var request = map__65751__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65751__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
