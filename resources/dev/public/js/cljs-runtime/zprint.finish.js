...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__50922_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__50922_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__50922_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__50923){
var vec__50924 = p__50923;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50924,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50924,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__50927,s,color,element,idx){
var map__50928 = p__50927;
var map__50928__$1 = cljs.core.__destructure_map(map__50928);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50928__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50928__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50928__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__50931 = (function (){var or__4212__auto__ = color;
...
var fexpr__50930 = (function (){var G__50932 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__50932) : style_map.call(null,G__50932));
})();
return (fexpr__50930.cljs$core$IFn$_invoke$arity$1 ? fexpr__50930.cljs$core$IFn$_invoke$arity$1(G__50931) : fexpr__50930.call(null,G__50931));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__50933){
var vec__50934 = p__50933;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50934,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50934,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50934,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__50937){
var vec__50938 = p__50937;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50938,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50938,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50938,(2),null);
...
var G__51003 = cljs.core.next(ssv);
var G__51004 = (this_ssv == null);
var G__51005 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__51006 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__51003;
doing_nil_QMARK_ = G__51004;
last_elide = G__51005;
out = G__51006;
continue;
}
...
var vec__50946 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50946,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50946,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50946,(2),null);
...
var G__51008 = cljs.core.next(remaining_cvec);
var G__51009 = new_idx;
var G__51010 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__51008;
idx = G__51009;
out = G__51010;
continue;
}
...
var G__51013 = cljs.core.next(ss_vec);
...
var G__51015 = (pos + cljs.core.count(cljs.core.first(ss)));
var G__51016 = ((((same_style_QMARK_) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(initial_pos,pos))))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.add_length(current)));
ss_vec = G__51013;
current = G__51014;
pos = G__51015;
out = G__51016;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__50953,cursor_vec){
var vec__50954 = p__50953;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50954,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50954,(1),null);
var focus_vec = vec__50954;
...
var vec__50957 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50957,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50957,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__50960){
var vec__50961 = p__50960;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50961,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50961,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__50970,existing_count){
var vec__50971 = p__50970;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50971,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50971,(1),null);
...
return cljs.core.filterv((function (p1__50965_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__50965_SHARP_))));
...
var vec__50981 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50981,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50981,(1),null);
var cvec_element = vec__50981;
if((cvec_element == null)){
var G__51020 = cljs.core.next(cvec_nl);
var G__51021 = (idx + (1));
var G__51022 = start;
var G__51023 = out;
cvec_nl = G__51020;
...
var G__51024 = cljs.core.next(cvec_nl);
var G__51025 = (idx + (1));
var G__51026 = idx;
var G__51027 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__51024;
idx = G__51025;
start = G__51026;
out = G__51027;
...
var G__51028 = cljs.core.next(cvec_nl);
var G__51029 = (idx + (1));
var G__51030 = (idx + (1));
var G__51031 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__51028;
idx = G__51029;
start = G__51030;
out = G__51031;
...
var G__51033 = cljs.core.next(cvec_nl);
var G__51034 = (idx + (1));
var G__51035 = idx;
var G__51036 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__51033;
idx = G__51034;
start = G__51035;
out = G__51036;
...
var G__51037 = cljs.core.next(cvec_nl);
var G__51038 = (idx + (1));
var G__51039 = start;
var G__51040 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__51037;
idx = G__51038;
start = G__51039;
out = G__51040;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__50986_SHARP_,p2__50985_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__50985_SHARP_)){
return cljs.core.reduced(p1__50986_SHARP_);
} else {
return (p1__50986_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__50987,p__50988){
var vec__50989 = p__50987;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50989,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50989,(1),null);
var vec__50992 = p__50988;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50992,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50992,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__50998,cvec,focus_vec){
var map__50999 = p__50998;
var map__50999__$1 = cljs.core.__destructure_map(map__50999);
var options = map__50999__$1;
var map__51000 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50999__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__51000__$1 = cljs.core.__destructure_map(map__51000);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51000__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51000__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51000__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50997_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__50997_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
