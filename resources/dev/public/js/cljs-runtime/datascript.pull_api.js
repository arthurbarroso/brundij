...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63969__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63969__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__63981 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__63981__$1 = (((G__63981 == null))?null:cljs.core.persistent_BANG_(G__63981));
if((G__63981__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__63981__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__64004){
...
var frame = first__64007;
var frames = seq__64006__$1;
...
var results = (function (){var G__64009 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__64009,kvps);
} else {
return G__64009;
}
})();
...
var map__64014 = parent;
var map__64014__$1 = cljs.core.__destructure_map(map__64014);
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64014__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64014__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_64095 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_64095,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__64016){
var vec__64017 = p__64016;
var seq__64018 = cljs.core.seq(vec__64017);
var first__64019 = cljs.core.first(seq__64018);
var seq__64018__$1 = cljs.core.next(seq__64018);
var parent = first__64019;
var frames = seq__64018__$1;
...
var found = cljs.core.not_empty((function (){var G__64020 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__64020);
} else {
return G__64020;
}
})());
...
var as_value = (function (){var G__64024 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__64015_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__64015_SHARP_]);
}),G__64024);
} else {
return G__64024;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__64025 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__64025);
} else {
return G__64025;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__64026 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__64026,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__64026;
}
})());
...
var vec__64027 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64027,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64027,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__64034){
var vec__64039 = p__64034;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64039,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64039,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__64048){
var vec__64049 = p__64048;
var seq__64050 = cljs.core.seq(vec__64049);
var first__64051 = cljs.core.first(seq__64050);
var seq__64050__$1 = cljs.core.next(seq__64050);
var frame = first__64051;
var frames = seq__64050__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__64052){
var vec__64053 = p__64052;
var seq__64054 = cljs.core.seq(vec__64053);
var first__64055 = cljs.core.first(seq__64054);
var seq__64054__$1 = cljs.core.next(seq__64054);
var frame = first__64055;
var frames = seq__64054__$1;
...
var vec__64056 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64056,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64056,(1),null);
...
var map__64063 = frame;
var map__64063__$1 = cljs.core.__destructure_map(map__64063);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64063__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64063__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__64064 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__64064,attr,eid);
} else {
return G__64064;
}
})();
...
var map__64065 = frame;
var map__64065__$1 = cljs.core.__destructure_map(map__64065);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64065__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64065__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__64066){
while(true){
var vec__64067 = p__64066;
var seq__64068 = cljs.core.seq(vec__64067);
var first__64069 = cljs.core.first(seq__64068);
var seq__64068__$1 = cljs.core.next(seq__64068);
var frame = first__64069;
var frames = seq__64068__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__64106 = db;
var G__64107 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__64106;
p__64066 = G__64107;
continue;
}
...
while(true){
var G__64078 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__64078__$1 = (((G__64078 instanceof cljs.core.Keyword))?G__64078.fqn:null);
switch (G__64078__$1) {
case "expand":
var G__64113 = db;
var G__64114 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__64113;
frames = G__64114;
continue;
...
case "expand-rev":
var G__64115 = db;
var G__64116 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__64115;
frames = G__64116;
continue;
...
case "pattern":
var G__64117 = db;
var G__64118 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__64117;
frames = G__64118;
continue;
...
case "recursion":
var G__64119 = db;
var G__64120 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__64119;
frames = G__64120;
continue;
...
var f = first__64082;
var remaining = seq__64081__$1;
var result = (function (){var G__64083 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__64083);
} else {
return G__64083;
}
})();
...
var G__64121 = db;
var G__64122 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__64084 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__64084,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__64084;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64078__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__64086_SHARP_){
return datascript.db.entid_strict(db,p1__64086_SHARP_);
})),eids);
