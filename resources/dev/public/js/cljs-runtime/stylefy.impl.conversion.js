...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__71223_SHARP_){
return handle_mode(p1__71223_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__71223_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__71224_SHARP_){
return handle_mode(cljs.core.first(p1__71224_SHARP_),cljs.core.second(p1__71224_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__71232,options){
var map__71233 = p__71232;
var map__71233__$1 = cljs.core.__destructure_map(map__71233);
var _style = map__71233__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71233__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71233__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71233__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
var css_props = stylefy.impl.utils.remove_special_keywords(props);
var css_selector = (function (){var or__4212__auto__ = custom_selector;
...
var garden_options = (function (){var or__4212__auto__ = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([options,garden_vendors], 0));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
 ...
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__71234,options){
var map__71235 = p__71234;
var map__71235__$1 = cljs.core.__destructure_map(map__71235);
var _style = map__71235__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71235__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71235__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71235__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__71236,options){
var map__71237 = p__71236;
var map__71237__$1 = cljs.core.__destructure_map(map__71237);
var _style = map__71237__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71237__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71237__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71237__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__71239,options){
var map__71240 = p__71239;
var map__71240__$1 = cljs.core.__destructure_map(map__71240);
var _style = map__71240__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71240__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71240__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71240__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
...
var css_parent_selector = (function (){var or__4212__auto__ = custom_selector;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return stylefy.impl.conversion.class_selector(hash);
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__71238_SHARP_){
if(cljs.core.map_QMARK_(p1__71238_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__71238_SHARP_);
} else {
return p1__71238_SHARP_;
}
