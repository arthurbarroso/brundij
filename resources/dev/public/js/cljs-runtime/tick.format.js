...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__73078 = goog.object.get(JSJodaLocale,"Locale");
if((G__73078 == null)){
return null;
} else {
return goog.object.get(G__73078,"US");
}
}catch (e73076){if((e73076 instanceof Error)){
var _e = e73076;
return null;
} else {
throw e73076;
