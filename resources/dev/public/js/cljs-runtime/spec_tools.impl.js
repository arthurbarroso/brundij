...
var vec__77851 = cljs.core.rest(expr);
var seq__77852 = cljs.core.seq(vec__77851);
var first__77853 = cljs.core.first(seq__77852);
var seq__77852__$1 = cljs.core.next(seq__77852);
var vec__77854 = first__77853;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77854,(0),null);
var form = seq__77852__$1;
...
var G__77859 = x;
var G__77859__$1 = (((G__77859 == null))?null:spec_tools.impl.polish(G__77859));
var G__77859__$2 = (((G__77859__$1 == null))?null:cljs.core.name(G__77859__$1));
if((G__77859__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__77859__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__77860 = x;
var G__77860__$1 = (((G__77860 == null))?null:cljs.core.name(G__77860));
if((G__77860__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__77860__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__77861){
var map__77862 = p__77861;
var map__77862__$1 = cljs.core.__destructure_map(map__77862);
var data = map__77862__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77862__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77862__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77862__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77862__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__77863){
var map__77864 = p__77863;
var map__77864__$1 = cljs.core.__destructure_map(map__77864);
var data = map__77864__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77864__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77864__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__77865 = data;
var G__77865__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__77865,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__77865);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__77865__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__77865__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__77869 = form;
var G__77869__$1 = (((G__77869 == null))?null:cljs.core.rest(G__77869));
if((G__77869__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__77869__$1);
}
})();
var G__77870 = m;
var G__77870__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__77870,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__77866_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__77866_SHARP_)));
})):G__77870);
var G__77870__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__77870__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__77867_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__77867_SHARP_)));
})):G__77870__$1);
var G__77870__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__77870__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__77868_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__77868_SHARP_));
})):G__77870__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__77870__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__77871 = (function (){var G__77872 = form;
var G__77872__$1 = (((G__77872 == null))?null:cljs.core.rest(G__77872));
if((G__77872__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__77872__$1);
}
})();
var map__77871__$1 = cljs.core.__destructure_map(map__77871);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77871__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77871__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77871__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77871__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__77873 = (function (){var and__4210__auto__ = (kw instanceof cljs.core.Symbol);
...
var form = (function (){var and__4210__auto__ = spec;
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__77874 = form;
var G__77874__$1 = (((G__77874 == null))?null:cljs.core.seq(G__77874));
var G__77874__$2 = (((G__77874__$1 == null))?null:cljs.core.first(G__77874__$1));
if((G__77874__$2 == null)){
return null;
} else {
var fexpr__77875 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__77875.cljs$core$IFn$_invoke$arity$1 ? fexpr__77875.cljs$core$IFn$_invoke$arity$1(G__77874__$2) : fexpr__77875.call(null,G__77874__$2));
}
})():null));
});
/**
...
var len__4818__auto___77893 = arguments.length;
var i__4819__auto___77894 = (0);
while(true){
if((i__4819__auto___77894 < len__4818__auto___77893)){
args__4824__auto__.push((arguments[i__4819__auto___77894]));

var G__77896 = (i__4819__auto___77894 + (1));
i__4819__auto___77894 = G__77896;
continue;
} else {
}
break;
...
return spec_tools.impl.deep_merge.cljs$core$IFn$_invoke$arity$variadic(argseq__4825__auto__);
});
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq77876){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq77876));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__77877){
var vec__77878 = p__77877;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77878,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77878,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__77883){
var map__77884 = p__77883;
var map__77884__$1 = cljs.core.__destructure_map(map__77884);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77884__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77884__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77884__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77884__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__77881_SHARP_){
return cljs.core.map_QMARK_(p1__77881_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__77882_SHARP_){
return cljs.core.contains_QMARK_(p1__77882_SHARP_,x);
});
}),req_keys));
