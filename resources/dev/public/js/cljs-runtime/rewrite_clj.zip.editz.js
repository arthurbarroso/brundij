...
var G__52605 = (function (){var G__52606 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__52606) : f.call(null,G__52606));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__52605) : rewrite_clj.node.coerce.call(null,G__52605));
});
/**
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__52608_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__52608_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq52609){
var G__52610 = cljs.core.first(seq52609);
var seq52609__$1 = cljs.core.next(seq52609);
var G__52611 = cljs.core.first(seq52609__$1);
var seq52609__$2 = cljs.core.next(seq52609__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52610,G__52611,seq52609__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__52615 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__52615) : str_fn.call(null,G__52615));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__52616 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__52616) : str_fn.call(null,G__52616));
})()):null)));
...
var G__52619 = rewrite_clj.zip.base.tag(zloc);
var G__52619__$1 = (((G__52619 instanceof cljs.core.Keyword))?G__52619.fqn:null);
switch (G__52619__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__52617_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52617_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__52618_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52618_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52619__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__52624 = rewrite_clj.zip.base.tag(zloc);
var G__52624__$1 = (((G__52624 instanceof cljs.core.Keyword))?G__52624.fqn:null);
switch (G__52624__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__52621_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52621_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52624__$1)].join('')));
