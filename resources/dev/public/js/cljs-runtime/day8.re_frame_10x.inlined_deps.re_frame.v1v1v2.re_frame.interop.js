...
return [(function (){var pred__45085 = cljs.core.instance_QMARK_;
var expr__45086 = reactive_val;
if(cljs.core.truth_((pred__45085.cljs$core$IFn$_invoke$arity$2 ? pred__45085.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__45086) : pred__45085.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__45086)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45085.cljs$core$IFn$_invoke$arity$2 ? pred__45085.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__45086) : pred__45085.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__45086)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45085.cljs$core$IFn$_invoke$arity$2 ? pred__45085.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__45086) : pred__45085.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__45086)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45085.cljs$core$IFn$_invoke$arity$2 ? pred__45085.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__45086) : pred__45085.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__45086)))){
return "tr";
} else {
return "other";
}
