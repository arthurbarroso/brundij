...
var i_56702 = (0);
while(true){
if((i_56702 < arr.length)){
(arr[i_56702] = null);

var G__56703 = (i_56702 + (1));
i_56702 = G__56703;
continue;
} else {
}
...
var i_56714 = (self__.level + (1));
while(true){
if((i_56714 <= (new_level + (1)))){
(update[i_56714] = self__.header);

var G__56715 = (i_56714 + (1));
i_56714 = G__56715;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_56716 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_56716[i]));
} else {
x__$2.forward.push((((i < links_56716.length))?(links_56716[i]):null));
}

if((i < links_56716.length)){
(links_56716[i] = x__$2);
} else {
links_56716.push(x__$2);
}
...
var i_56731 = (0);
while(true){
if((i_56731 <= self__.level)){
var links_56732 = (update[i_56731]).forward;
if((x__$1 === (((i_56731 < links_56732.length))?(links_56732[i_56731]):null))){
(links_56732[i_56731] = (x__$1.forward[i_56731]));

var G__56734 = (i_56731 + (1));
i_56731 = G__56734;
continue;
} else {
var G__56736 = (i_56731 + (1));
i_56731 = G__56736;
continue;
}
} else {
...
var G__56740 = nx;
var G__56741 = (level__$1 - (1));
x = G__56740;
level__$1 = G__56741;
continue;
} else {
var G__56743 = x;
var G__56744 = (level__$1 - (1));
x = G__56743;
level__$1 = G__56744;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__56748 = nx;
var G__56749 = (level__$1 - (1));
x = G__56748;
level__$1 = G__56749;
continue;
} else {
var G__56750 = x;
var G__56751 = (level__$1 - (1));
x = G__56750;
level__$1 = G__56751;
continue;
}
...
var or__4212__auto__ = (cljs.core.truth_((function (){var and__4210__auto__ = me__$1;
