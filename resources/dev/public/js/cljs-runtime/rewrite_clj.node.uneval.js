...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k51465,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k51465,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__51471){
var vec__51472 = p__51471;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51472,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51472,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__51464){
var self__ = this;
var G__51464__$1 = this;
return (new cljs.core.RecordIter((0),G__51464__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51466,other51467){
var self__ = this;
var this51466__$1 = this;
return (((!((other51467 == null)))) && ((((this51466__$1.constructor === other51467.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51466__$1.children,other51467.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51466__$1.__extmap,other51467.__extmap)))))));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k51465){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k51465);

}
}));

(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__51464){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__51482 = cljs.core.keyword_identical_QMARK_;
var expr__51483 = k__4470__auto__;
if(cljs.core.truth_((pred__51482.cljs$core$IFn$_invoke$arity$2 ? pred__51482.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__51483) : pred__51482.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__51483)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__51464,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__51464),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__51464){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__51464,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__51468){
var extmap__4501__auto__ = (function (){var G__51485 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__51468,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__51468)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__51485);
} else {
return G__51485;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__51468),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
...
var G__51488 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__51488;
continue;
}
break;
