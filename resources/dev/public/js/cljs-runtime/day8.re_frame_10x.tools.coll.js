...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__49480_SHARP_,p2__49479_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__49479_SHARP_) : pred.call(null,p2__49479_SHARP_)))){
return p1__49480_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__49482_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__49482_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__49482_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__49483){
var vec__49484 = p__49483;
var seq__49485 = cljs.core.seq(vec__49484);
var first__49486 = cljs.core.first(seq__49485);
var seq__49485__$1 = cljs.core.next(seq__49485);
var k = first__49486;
var ks = seq__49485__$1;
var keys = vec__49484;
if(ks){
