...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_47112 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_47112(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_47114 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_47114(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47118 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47118(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47119 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47119(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47120 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47120(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47121 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47121(reader);
}
});
...
var G__47142 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__47143 = s.append(c);
c = G__47142;
s = G__47143;
continue;
}
