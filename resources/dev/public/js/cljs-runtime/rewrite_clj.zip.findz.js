...
var len__4818__auto___52584 = arguments.length;
var i__4819__auto___52585 = (0);
while(true){
if((i__4819__auto___52585 < len__4818__auto___52584)){
args__4824__auto__.push((arguments[i__4819__auto___52585]));

var G__52586 = (i__4819__auto___52585 + (1));
i__4819__auto___52585 = G__52586;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__52515){
var vec__52516 = p__52515;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52516,(0),null);
...
return (function (p1__52496_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__52496_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq52498){
var G__52499 = cljs.core.first(seq52498);
var seq52498__$1 = cljs.core.next(seq52498);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52499,seq52498__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__52520,p__52521){
var map__52522 = p__52520;
var map__52522__$1 = cljs.core.__destructure_map(map__52522);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52522__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52522__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52522__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52522__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__52523 = p__52521;
var map__52523__$1 = cljs.core.__destructure_map(map__52523);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52523__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52523__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52527_SHARP_){
var and__4210__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__52527_SHARP_) : p_QMARK_.call(null,p1__52527_SHARP_));
if(cljs.core.truth_(and__4210__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__52527_SHARP_)),pos);
} else {
return and__4210__auto__;
}
...
var G__52543 = zloc;
var G__52543__$1 = (((G__52543 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__52543) : f.call(null,G__52543)));
if((G__52543__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__52543__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__52544_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__52544_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__52549_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__52549_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__52576_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__52576_SHARP_),v);
}));
