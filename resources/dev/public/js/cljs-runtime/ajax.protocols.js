...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_65503 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_65503(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_65504 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_65504(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_65505 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_65505(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_65506 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_65506(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_65507 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_65507(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_65508 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_65508(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_65509 = (function (this$,header){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_65509(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_65510 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_65510(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_65511 = (function (this$,request){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_65511(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_65514 = (function (this$,response){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_65514(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k65489,else__4464__auto__){
var self__ = this;
var this__4463__auto____$1 = this;
var G__65493 = k65489;
var G__65493__$1 = (((G__65493 instanceof cljs.core.Keyword))?G__65493.fqn:null);
switch (G__65493__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65489,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__65494){
var vec__65495 = p__65494;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65495,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65495,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__65488){
var self__ = this;
var G__65488__$1 = this;
return (new cljs.core.RecordIter((0),G__65488__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65490,other65491){
var self__ = this;
var this65490__$1 = this;
return (((!((other65491 == null)))) && ((((this65490__$1.constructor === other65491.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65490__$1.status,other65491.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65490__$1.body,other65491.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65490__$1.status_text,other65491.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65490__$1.headers,other65491.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65490__$1.was_aborted,other65491.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65490__$1.__extmap,other65491.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k65489){
var self__ = this;
var this__4468__auto____$1 = this;
var G__65498 = k65489;
var G__65498__$1 = (((G__65498 instanceof cljs.core.Keyword))?G__65498.fqn:null);
switch (G__65498__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k65489);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__65488){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__65499 = cljs.core.keyword_identical_QMARK_;
var expr__65500 = k__4470__auto__;
if(cljs.core.truth_((pred__65499.cljs$core$IFn$_invoke$arity$2 ? pred__65499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__65500) : pred__65499.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__65500)))){
return (new ajax.protocols.Response(G__65488,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65499.cljs$core$IFn$_invoke$arity$2 ? pred__65499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__65500) : pred__65499.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__65500)))){
return (new ajax.protocols.Response(self__.status,G__65488,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65499.cljs$core$IFn$_invoke$arity$2 ? pred__65499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__65500) : pred__65499.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__65500)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__65488,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65499.cljs$core$IFn$_invoke$arity$2 ? pred__65499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__65500) : pred__65499.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__65500)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__65488,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65499.cljs$core$IFn$_invoke$arity$2 ? pred__65499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__65500) : pred__65499.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__65500)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__65488,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__65488),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__65488){
var self__ = this;
var this__4460__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__65488,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__65492){
var extmap__4501__auto__ = (function (){var G__65502 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65492,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__65492)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65502);
} else {
return G__65502;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__65492),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__65492),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__65492),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__65492),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__65492),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
