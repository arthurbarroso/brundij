...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_59544 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_59544(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_59563 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_59563(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_59572 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_59572(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_59593 = (function (thing,opts){
...
var meta_impl__4511__auto__ = temp__5733__auto__;
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_59593(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_59597 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_59597(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_59598 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_59598(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__59517,callback){
var map__59518 = p__59517;
var map__59518__$1 = cljs.core.__destructure_map(map__59518);
var input = map__59518__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59518__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59518__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
